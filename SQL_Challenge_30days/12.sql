...
INSERT INTO purchases VALUES (2171, 145, '2024-02-22 00:00:00', 43001, 1000),
...
SELECT 
  department,
  AVG( CASE WHEN end_date ISNULL THEN CURRENT_DATE - start_date 
